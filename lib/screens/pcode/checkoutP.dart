...
class CheckOutP extends StatefulWidget {
  @override
  State<CheckOutP> createState() => _CheckOutPState();
}

class _CheckOutPState extends State<CheckOutP> {
  var addressData;
  Map addressList = Map();
